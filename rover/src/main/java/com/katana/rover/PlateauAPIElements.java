...
public class PlateauAPIElements {
    ...
    public static void enviar(int x, int y, String sentido, GridElementType elementType) {
        // URL de la API a la que deseas enviar los datos
        String apiUrl = "http://localhost:8080/api/rover/obstacle";
        // Crear un mapa de datos para representar los valores a enviar en JSON
        Long id_plateau = (long) obtenerDatos();
